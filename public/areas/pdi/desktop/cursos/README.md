# Cursos Manuais - Desktop

Esta pasta contém os cursos manuais da equipe **Desktop**.
...
```json
{
    ...
    "type": "manual",
    "coursePath": "areas/pdi/desktop/cursos/meu-curso",
