# Cursos Manuais - Modelos

Esta pasta contém os cursos manuais da equipe **Modelos**.
...
```json
{
    ...
    "type": "manual",
    "coursePath": "areas/pdi/modelos/cursos/meu-curso",
